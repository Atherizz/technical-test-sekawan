<x-admin>
    <main class="flex-1 overflow-y-auto p-6">
        <div class="mb-6">
            ...
            <p class="text-gray-600">Update the driver information below</p>
        </div>

        <form action="{{ route('drivers.update', $driver->id) }}" method="POST" class="bg-white rounded-lg shadow p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="flex justify-end space-x-3">
                ...
                <button type="submit"
                    class="px-4 py-2 bg-primary-600 text-white rounded-md hover:bg-primary-700 text-sm">Update Driver</button>
            </div>
        </form>
    </main>
</x-admin>
