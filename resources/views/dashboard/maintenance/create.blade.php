<x-admin>
    <main class="flex-1 overflow-y-auto p-6">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Add New Maintenance Schedule</h1>
            <p class="text-gray-600">Fill in the form below to schedule a new maintenance</p>
        </div>

        <form action="{{ route('maintenance_schedule.store') }}" method="POST" class="bg-white rounded-lg shadow p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="date" name="maintenance_date" id="maintenance_date" value="{{ old('maintenance_date') }}" required
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
